...
let movies = [
  {
    ...
    "Genre": {
      "Name": 'Action',
      "Description": 'A genre that emphasizes high-energy sequences, intense physical stunts, and adrenaline-pumping conflict. Characters often face life-threatening situations, with scenes filled with chases, battles, and explosive confrontations.',
    },
    "Director": {
      "Name": 'Joss Whedon',
...

  {
    ...
    "Genre": {
      "Name": 'Comedy',
      "Description:": 'A light-hearted genre focused on humor, where the primary goal is to entertain and amuse. Comedy often involves exaggerated characters, witty dialogue, and situations that lead to laughter and fun, providing a feel-good experience.',
    },
    "Director": {
      "Name": 'Tim Miller',
  ...
  
  {
    ...
    "Genre": {
      "Name": 'Fantasy',
      "Description": 'A genre that transports audiences to imaginative worlds filled with magical creatures, epic quests, and supernatural elements. Fantasy often explores themes of good versus evil, featuring heroes who embark on adventures beyond the realm of the ordinary.',
    },
    "Director": {
      "Name": 'Sam Raimi',
  ...
  
  {
    ...
    "Genre": {
      "Name": 'Drama',
      "Description": 'A genre centered on realistic, emotional storytelling that delves into complex characters and situations. Drama often explores themes of love, conflict, and moral dilemmas, with a focus on character development and the human condition.',
    },
    "Director": {
      "Name": 'Sam Raimi',
      "Bio": "Sam Raimi is an American filmmaker born on October 23, 1959, in Michigan. He is best known for directing The Evil Dead (1981) and the Spider-Man trilogy (2002-2007) starring Tobey Maguire. Raimi’s work blends horror, humor, and inventive storytelling, making him a key figure in both horror and superhero genres. He recently returned to superhero films with Doctor Strange in the Multiverse of Madness (2022).",
